...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        tmp_res = HAS_ATTR_BOOL2(tmp_expression_value_2, mod_consts[160]);
        if (tmp_res == -1) {
            assert(ERROR_OCCURRED());
    ...
    branch_yes_5:;
    {
        ...
        tmp_mod_expr_right_2 = MAKE_TUPLE_EMPTY(2);
        {
            ...
            tmp_tuple_element_6 = LOOKUP_ATTRIBUTE(tmp_expression_value_12, mod_consts[163]);
    ...
    branch_yes_8:;
    {
        ...
        tmp_mod_expr_right_3 = MAKE_TUPLE_EMPTY(2);
        {
            ...
            tmp_tuple_element_10 = LOOKUP_ATTRIBUTE(tmp_expression_value_18, mod_consts[163]);
    ...
    }
    {
        ...
        tmp_res = HAS_ATTR_BOOL2(tmp_expression_value_20, mod_consts[160]);
        if (tmp_res == -1) {
            assert(ERROR_OCCURRED());
    ...
    branch_yes_10:;
    {
        ...
        tmp_called_value_7 = LOOKUP_ATTRIBUTE(tmp_expression_value_21, mod_consts[160]);
        if (tmp_called_value_7 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
        ...
        tmp_res = HAS_ATTR_BOOL2(tmp_expression_value_22, mod_consts[161]);
        if (tmp_res == -1) {
            assert(ERROR_OCCURRED());
    ...
    branch_yes_11:;
    {
        ...
        tmp_mod_expr_right_4 = MAKE_TUPLE_EMPTY(2);
        {
            ...
            tmp_tuple_element_14 = LOOKUP_ATTRIBUTE(tmp_expression_value_24, mod_consts[163]);
